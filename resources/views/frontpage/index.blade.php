            ...
            <section class="col-span-3 m-[1rem]">
                <div class="flex items-center mb-4 ">
                    <select name="sort" id="sort"
                        class="w-44 text-sm text-gray-600 py-3 px-4 border-gray-300 shadow-sm rounded focus:ring-primary focus:border-primary border-2 rounded-md">
                ...
                <div class="grid md:grid-cols-3 sm:grid-cols-2 grid-cols-2 gap-6 text-center">
                    ...
                    <div class="bg-white shadow rounded overflow-hidden group ">
                        ...
                        <div class="pt-4 pb-3 px-4">
                            ...
                            <div class="flex items-baseline mb-1 space-x-2">
                                <p class="text-xl text-primary font-semibold text-gray-500">Rp 10.000</p>
